    ...
    <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo" style="position: static;">
				<h1><a href="index.php">Lord's Ranch <span>Admin</span></a></h1>
			</div>
					...
					<ul class="nav nav-pills nav-stacked custom-nav">
						...
						<li class="menu-list">
							<a href="#"><i class="lnr lnr-users"></i>
								...
								<ul class="sub-menu-list">
									...
									<li><a href="all-excos.php">All Testimonials</a></li>
								</ul>
						</li>
						...
						<li class="menu-list"><a href="#"><i class="lnr lnr-picture"></i> <span>Manage Gallery</span></a>
							<ul class="sub-menu-list">
								...
								<li><a href="delete-photo.php">All Photos</a> </li>
							</ul>
						</li> 
						<li class="menu-list"><a href="#"><i class="lnr lnr-envelope"></i> <span>Manage Contacts</span></a>
						<ul class="sub-menu-list">
						<li><a href="contact-form.php">View All Contacts</a> </li>
						</ul>
						</li> 
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(images/user_admin.png) no-repeat center"> </span> 
										 <div class="user-name">
