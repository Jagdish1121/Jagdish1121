<?php include"header.php"; ?>
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">All Contacts</h3>
					 <div class="xs tabls">
					 <div class="panel-body1">
					 <?php if(get("success")):?>
                                            <div>
                                               <?=App::message("success", "Successfully deleted a Contact!")?>
                                            </div>
                                            <?php endif;?>
					   <table class="table">
					    <thead>
						  ...
						  <tbody>
						   <?php                     //include('../connect.php');
                            if(!isset($_GET["page"])){
                                ...
                                $tbl_name="contact_form";		//your table name
	...
	*/
	...
	/* Get data. */
				...
				$result = $db->prepare("SELECT * FROM contact_form  ORDER BY id DESC LIMIT $start, $limit");
				$result->execute();
	 ...
	 ?>
               ...
               ?> 
							...
							<tr>
							  ...
							  <td>
							    <a href="delete-contact-form.php?id=<?=$row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn" >Delete</a>
