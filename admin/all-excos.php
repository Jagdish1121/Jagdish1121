<?php include"header.php"; ?>
	<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<h3 class="blank1">All Testimonials</h3>
					 <div class="xs tabls">
					 <div class="panel-body1">
					 <?php if(get("success")):?>
                                            <div>
                                               <?=App::message("success", "Successfully deleted a Testimonial!")?>
                                            </div>
                                            <?php endif;?>
					   <table class="table">
					    <thead>
	 ...
	 ?>
               ...
               ?> 
							...
							<tr>
							  ...
							  <td>
							    <a href="delete-excos.php?id=<?=$row['id'] ?>" class="fa fa-eraser btn btn-xs btn-success warning_4 delbtn" >Delete</a>
