...
<style>
    ...
    .block, .block2, .block3 {
        /* align-items: center; */
        padding: 25px 10px; /* Adjusted padding for smaller screens */
    ...
    @media screen and (max-width: 767px) {
        .block, .block2, .block3 {
            padding: 15px 5px; /* Adjusted padding for smaller screens */
        }

        h3 {
            font: 16px; /* Adjusted font size for smaller screens */
        }
